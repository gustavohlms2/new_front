...
export default {
  ...
  listar:()=>{
    ...
    */
        ...
        validaTelefone() {
            if( this.acessorAlterar.telefone.length < 8 && this.acessorAlterar.telefone.length > 17 ){
        ...
        validaCnpj() {
            if( this.acessorAlterar.cnpj.length != 14  ){
        ...
        validaCpf() {
            if( this.acessorAlterar.cpf.length != 11  ){
